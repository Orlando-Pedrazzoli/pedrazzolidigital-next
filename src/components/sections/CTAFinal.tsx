...
export default function CTAFinal() {
  ...
  const inputTheme =
    'w-full px-4 py-3.5 rounded-xl text-sm outline-none transition-all bg-zinc-50 dark:bg-white/6 border border-zinc-200 dark:border-white/10 text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-white/30 focus:border-green-500 dark:focus:border-green-500 focus:bg-white dark:focus:bg-white/8 focus:ring-1 focus:ring-green-500/30';
