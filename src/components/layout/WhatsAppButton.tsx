...
export default function WhatsAppButton() {
  return (
    <a href={getWhatsAppUrl()} target="_blank" rel="noopener noreferrer" aria-label="Fale conosco pelo WhatsApp"
      ...
      <MessageCircle size={28} color="#ffffff" fill="#ffffff" strokeWidth={1.8} />
    </a>
  )
}
