...
import { getBusinessWhatsApp } from '@/lib/whatsapp';
    ...
    <section id='solucoes' className='py-24 px-6 bg-white dark:bg-zinc-950'>
      <div className='max-w-7xl mx-auto'>
        <SectionHeader
          ...
          description='Cada negócio tem necessidades diferentes. Desenvolvo soluções específicas para o seu segmento.'
        />
        <FadeIn>
            ...
            {businessTypes.map((bt, idx) => (
              ...
              >
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${bt.gradientFrom}, ${bt.gradientTo})`,
                  }}
                >
                  <h3
